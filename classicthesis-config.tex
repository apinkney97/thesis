...
% ****************************************************************************************************
\newcommand{\myTitle}{Flexible Structures for Multi-modal Electronic Documents\xspace}
\newcommand{\mySubtitle}{this is supposed to be a subtitle\xspace}
\newcommand{\myNewDegree}{Doctor of Philosophy\xspace}
\newcommand{\myOldDegree}{BSc (Hons)}
...
\newcommand{\myVersion}{DRAFT version 0.5\xspace}
