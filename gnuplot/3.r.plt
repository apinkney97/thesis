...
set yra [0:6]
plot "./3.csv" u ($3):($1/7706.0/$3) i 0 title columnheader(1), '' u ($3):($1/23518.0/$3) i 1 title columnheader(1), '' u ($3):($1/5560743.0/$3) i 2 title columnheader(1), '' u ($3):($1/4432380.0/$3) i 3 title columnheader(1)
