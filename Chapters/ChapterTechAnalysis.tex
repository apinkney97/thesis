...
Crucially, the layout instructions are not parametric, and hence do not permit computation, which ensures that the document is always rendered identically.
...
The layout algorithm for a malleable document is as follows:
