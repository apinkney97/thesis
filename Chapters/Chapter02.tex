...
\todo{Point out that these documents don't allow interesting things like floats (only non-floating blocks)\\Point out that the implementation in Acrobat is clunky and impractical for ebook readers (but that the algorithm stands)}
