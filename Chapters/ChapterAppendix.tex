...
It contains three \gls{galley} renderings, and has ordered dictionaries both for words, and for position deltas.
...
All the Malleable Document System layouts use the same selection of \gls{galley} renderings as were used in Rendering D of the user study\ed see Table~\ref{tab:galleypool} on page~\pageref{tab:galleypool}.
