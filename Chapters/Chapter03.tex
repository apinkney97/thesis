        ...
        if (item is a floatable object) {
            ...
            foreach (width in galleyWidths) {
                ...
                foreach (line returned by linebreaker) {
                    add this line's words and positioning data to galley container;
                }
