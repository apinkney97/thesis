...
\begin{figure}
 \fbox{\includegraphics[trim=1.8in 5.8in 3.4in 4.25in, clip=true, width=\textwidth]{gfx/kerningetc}}
...
\todo{ADD A REFERENCE TO AFM SPEC}
...
\begin{figure}
\fbox{\includegraphics[width=\textwidth]{gfx/acrobatreflow}}
